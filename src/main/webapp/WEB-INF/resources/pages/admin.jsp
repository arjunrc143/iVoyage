...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/pages/angular/app/adminApp.js"></script>
...
<body ng-app="Admin" ng-controller="AdminController">
	...
	<center>
		...
		<div class="container">
			<div class="z-depth-1 white lighten-5/css/materialize row"
				...
				<form class="col s12" ng-submit="submitQuery()">
					...
					<div class='row'>
						<div class='input-field col s12'>
							<input class='validate' ng-model="adminForm.username" type='text'
								name='username' id='username' /> <label for='username'>Admin
								Id</label>
						</div>
					</div>
					...
					<div class='row'>
						<div class='input-field col s12'>
							<input class='validate' type='password'
								ng-model="adminForm.password" name='password' id='password' />
					...
					<center>
						<div class='row'>
							<button type='submit' name='btn_login'
								class='col s12 btn btn-large waves-effect red'>Login</button>
						</div>
					</center>
				</form>
			</div>
